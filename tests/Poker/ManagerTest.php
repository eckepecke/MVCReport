...
class ManagerTest extends TestCase
{
    ...
    //     $manager->addManager('handEvaluator', $handEvaluator);

    //     $manager->addGame($game);

    //     $game->addPlayers($pArray);
    //     $game->addDealer($cardManager);
    //     $game->addManager($manager);
    // }

    // public function testHandStrengthUpdate(): void
    // {
    //     $initialStrength = "";
    //     $this->manager->dealStartingHands($this->manager->game->getGameState(), null);
    ...
    //     $updatedStrength =
    //     $this->assertNotSame($initialStrength, $updatedStrength);
